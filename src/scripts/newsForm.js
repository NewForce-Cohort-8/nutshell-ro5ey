...
export const NewsForm = () => {
    ...
    <div id="newsForm"
      ...
      <div class="field">
        ...
        <input type="text" name="newsTitle" class=input required/>
      </div>
      <div class="field">
        <label class="label" for="newsSynopsis">Synopsis</label>
        <input type="text" name="newsSynopsis" class=input required/>
      </div>
      <div class="field">
        <label class="label" for="newsUrl">URL</label>
        <input type="text" name="newsUrl" class=input required/>
      </div>
